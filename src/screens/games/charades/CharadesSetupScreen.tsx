                ...
                <View style={styles.optionGrid}>
                    {[30, 60, 90, 120].map((seconds) => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.optionButton,
                                roundTimeSeconds === seconds && styles.selectedOption,
                            ]}
                            activeOpacity={0.85}
                            onPress={() => setRoundTimeSeconds(seconds)}
                        >
                            <Text
                                style={[
                                    styles.optionText,
                                    roundTimeSeconds === seconds && styles.selectedOptionText,
                                ]}
                            >
                ...
                <View style={styles.optionGrid}>
                    {[3, 5, 7].map((num) => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.optionButton,
                                totalRounds === num && styles.selectedOption,
                            ]}
                            activeOpacity={0.85}
                        ...
                        >
                            <Text
                                style={[
                                    styles.optionText,
                                    totalRounds === num && styles.selectedOptionText,
                                ]}
                            >
                                {num} Rounds
                            </Text>
